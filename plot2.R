# *********************************************************************************************************
# plot2.R code : This file generates an exploratory line graph for 
...
#   5) Line graph generated for Global Averaged Active power consumption against the time
#   6) Generated plot is saved into plot2.png file
...
plot2 <- function()
{
  ...
  # generate line graph and copy it to plot2.png file
  #----------------------------------------------------
